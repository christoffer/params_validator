...
class TestActionController < ActionController::Base
  include ::RailsParamsChecker::ClassMethods
  check_params_for :index, { :q => { :required => true } }
end

describe RailsParamsChecker::ClassMethods do
  describe 'class_attribute' do
    it 'should define class_attribute on the controller' do
      TestActionController.should respond_to(:params_check_definitions)
    end
  end

  describe 'class_method' do
    it 'should respond to check_params_for' do
      TestActionController.should respond_to(:check_params_for)
    end
  end

  describe 'dynamic filter methods' do
    it 'should have check_params_for_action_index defined' do
      TestActionController.new.should respond_to(:check_params_for_action_index)
    end
  end

  describe 'before filters' do
    subject { TestActionController._process_action_callbacks.select { |f| f.filter == :check_params_for_action_index }.first }
  ...
  describe 'check_params_for' do
    subject { TestActionController.params_check_definitions }
